return function()
    ...
    local RbxGui = _G.LoadLibrary("RbxGui")
    ...
    local function createGameMainMenu(baseZIndex, shield)
        ...
        stopRecordButton.Image = "rbxassetid://16440262343"--"rbxasset://textures/ui/RecordStop.png"
    ...
    local function createGameSettingsMenu(baseZIndex, shield)
        ...
        if hasGraphicsSlider then
            ...
            local function setGraphicsQualityLevel(newLevel)
                ...
                local newSetting = math.floor((21 - 1) * percentage)
            ...
            graphicsSetter.FocusLost:connect(function()
                ...
                elseif newGraphicsValue >= 21 then
                    newGraphicsValue = 21 - 1
                end
            ...
            local wasManualGraphics = (userSettings.SavedQualityLevel ~= Enum.SavedQualitySetting.Automatic)
            if UserSettings().GameSettings:InStudioMode() then
            ...
            if hasGraphicsSlider then
                 UserSettings().GameSettings.StudioModeChanged:connect(function(isStudioMode)
                    if isStudioMode then
                        wasManualGraphics = (userSettings.SavedQualityLevel ~= Enum.SavedQualitySetting.Automatic)
                        goToAutoGraphics()
                        studioCheckbox.Text = "X"
                        autoGraphicsButton.ZIndex = 1
                        autoText.ZIndex = 1
        ...
        local mouseLockLabel = script.Parent:FindFirstChild("MouseLockLabel",true)
        ...
        if mouseLockLabel then
            mouseLockLabel.Visible = UserSettings().GameSettings.ControlMode == Enum.ControlMode["Mouse Lock Switch"]
            UserSettings().GameSettings.Changed:Connect(function(prop)
                if prop == "ControlMode" then
                    if UserSettings().GameSettings.ControlMode == Enum.ControlMode["Mouse Lock Switch"] then
                        mouseLockLabel.Visible = true
                    else
                        mouseLockLabel.Visible = false
            ...
            --[[task.spawn(function()
                ...
                uis.Changed:Connect(function(prop)
                    if prop == "MouseBehavior" and uis[prop] == Enum.MouseBehavior.LockCenter and not getFirstPerson() then
                        mouseLockLabel.Image = "rbxassetid://16441982483"
                        mouseLockLabel.HoverImage = "rbxassetid://16441982300"
                    elseif prop == "MouseBehavior" and uis[prop] == Enum.MouseBehavior.Default then
                        mouseLockLabel.Image = "rbxassetid://16441982688"
      ...
      if true then
        local createSettingsDialog = function()
            ...
            if settingsButton == nil then
                ...
                settingsButton.Image = "rbxassetid://16440262075"--"rbxasset://textures/ui/SettingsButton.png"
                settingsButton.HoverImage = "rbxassetid://16440261061"
            ...
            script.Parent.Changed:connect(function(prop) -- We have stopped recording when we resize
            ...
            game:GetService("UserInputService").InputBegan:Connect(function(key,sank)
                if key.KeyCode == Enum.KeyCode.Escape and not sank then
                    if currentMenuSelection == nil then
                        --[[game.GuiService:AddCenterDialog(shield, Enum.CenterDialogType.ModalDialog,
                            --showFunction
                            function()
    ...
    local createChatBar = function()
        ...
        game:GetService("UserInputService").InputBegan:Connect(function(key,sank)
            if key.KeyCode == Enum.KeyCode.Slash and not sank and hotKeyEnabled then
                task.wait()
                activateChat()
            end
        end)
                ...
                if enterPressed then
                    if chatBox.Text ~= "" then
                        ...
                        if string.sub(str, 1, 1) == '%' then
                            ...
                            tcs.TextChannels["RBXTeam"..tostring(game.Players.LocalPlayer.TeamColor)]:SendAsync(string.sub(str, 2))
                        else
        ...
        delay(0,
            function()
                ...
                if advancedChatBarSupported then
                    ...
                    chatBar.Parent = gui
                    _G.SetGlobalSizeOffsetPixel(0,-22)
                end
            end)
    end

return function()
	...
	local closeButton = backpack:WaitForChild("Tabs"):WaitForChild("CloseButton")
	...
	local gearPreview = backpack:WaitForChild("Gear"):WaitForChild("GearPreview")
	local scroller = backpack.Gear:WaitForChild("GearGridScrollingArea")

	local currentLoadout = backpack.Parent:WaitForChild("CurrentLoadout")

	local backpackButton = backpack.Parent:WaitForChild("ControlFrame"):WaitForChild("BackpackButton")

	local gearButton = backpack.Gear:WaitForChild("GearGrid"):WaitForChild("GearButton")
	local grid = backpack.Gear.GearGrid


	local searchBox = backpack.Gear.GearGrid:WaitForChild("SearchFrame"):WaitForChild("SearchBoxFrame"):WaitForChild("SearchBox")

	local searchButton = backpack.Gear.GearGrid.SearchFrame:WaitForChild("SearchButton")

	local resetFrame = backpack.Gear.GearGrid:WaitForChild("ResetFrame")

	local resetButton = backpack.Gear.GearGrid.ResetFrame:WaitForChild("ResetButtonBorder")

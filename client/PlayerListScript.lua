return function()
	...
	if true then
		...
		createBoardsFunction = function (boardType, numStatColumns)
			...
			playerListButton.BackgroundTransparency = 1
			playerListButton.Image = "rbxassetid://16430552256"--"rbxasset://textures/ui/playerlist_small_maximize.png"
			...
			playerListButton.BackgroundTransparency = 1
			playerListButton.Image = "rbxassetid://16430517514"--"rbxasset://textures/ui/playerlist_small_hide.png"
			...
			playerListButton = Instance.new("ImageButton")
			playerListButton.Name = "CloseButton"
			playerListButton.Image = "rbxassetid://16430534645"--"rbxasset://textures/ui/playerlist_big_hide.png"
			playerListButton.HoverImage = "rbxassetid://16430534432"
			playerListButton.BackgroundTransparency = 1
		...
		--[[game.GuiService.KeyPressed:connect(
			...
			game:GetService("UserInputService").InputBegan:Connect(function(key, sank)
				if key.KeyCode == Enum.KeyCode.Tab and not sank then
					local modalCheck, isModal = pcall(function() return game.GuiService.IsModalDialog end)
					if modalCheck == false or (modalCheck and isModal == false) then
						local currentTime = time()
						if lastTime == nil or currentTime - lastTime > 0.4 then
